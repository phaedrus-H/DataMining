...
T =[['1','2'],['2','3'],['2','3','4'],['5','6'],['1','2','5','7'],['1','2','5','4'],['2','4','3']]
MS = {'1':0.25, '2':0.70, '3':0.25, '4':0.50, '5':0.25, '6':0.25, '7':0.25}
SDC = 1
...
M = list(OrderedDict(sorted(MS.items(), key=operator.itemgetter(1))))
SM = OrderedDict(sorted(MS.items(), key=operator.itemgetter(1)))
